...
var readRole = resourceId('Microsoft.Authorization/roleDefinitions', 'acdd72a7-3385-48ef-bd42-f606fba81ae7')
...
resource webAcrReadAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(webAppServiceName)
  scope: containerRegistry
  properties: {
    principalId: webAppService.identity.principalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: readRole
  }
}

resource apiAcrReadAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(apiAppServiceName)
  scope: containerRegistry
  properties: {
    principalId: apiAppService.identity.principalId
